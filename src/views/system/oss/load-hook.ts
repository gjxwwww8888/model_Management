...
const tableHeadColumns = ref([
  ...
  { prop: 'createTime', label: '下载时间', minWidth: 150, isTemplate: false, align: 'center', showColumn: true },
  { prop: 'createBy', label: '下载人', minWidth: 150, isTemplate: false, align: 'center', showColumn: true },
