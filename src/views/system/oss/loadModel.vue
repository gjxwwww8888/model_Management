...
// import AddEditModal from './addModel.vue'

import { colChange, currentHook, handleAdd, handleSelectionChange, removeEmptyKey } from './load-hook'
...
<template>
  <div class="p-10px">
    <el-form v-show="showSearch" :model="queryParams" :inline="true" label-width="80px">
      ...
      <el-form-item label="下载时间" style="width: 150px}">
        <el-date-picker
          v-model="timeRange"
